\chapter{Progettazione concettuale}
    ...
    \begin{longtable}[c]{|l|l|l|}
      ...
      presentato ... presenta &
        ...
        \begin{tabular}[c]{@{}l@{}}Uno o pi\'u articoli \\ possono essere \\ presentati in una \\ conferenza. Un libro \\ pu\`o essere presentato\\ durante un evento.n\\ {[}0..1, 1...*{]}\end{tabular} \\ \hline
