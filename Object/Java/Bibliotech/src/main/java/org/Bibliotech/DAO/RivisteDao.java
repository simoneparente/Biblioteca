...
public interface RivisteDao {
    public boolean addRivista(String issn, String nome, String argomento, String dataPubblicazione, String lingua, String formato, String responsabile, String prezzo);
